              ...
              <div class="row">
                ...
                <div class="col-lg-3">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="seat_number" class="form-control" required="required" autocomplete="off">
                  </div>
                ...
                <div class="col-lg-3">
                  <div class="form-group">
                    ...
                    <select class="form-control" name="mentor_id">
                      ...
                      @foreach ( $mentors as $mentor)
                        <option value="{{$mentor->id}}">{{ $mentor->full_name }}
                        </option>
                      @endforeach
                    </select>
                  </div>
                  <div class="form-group">
                    ...
                    <input type="text" name="class_timing" class="form-control">
                  </div>
