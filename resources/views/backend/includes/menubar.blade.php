    ...
    <div class="br-sideleft sideleft-scrollbar">
      ...
      <ul class="br-sideleft-menu">
        ...
        <li class="br-menu-item">
          <a href="#" class="br-menu-link with-sub">
            <i class="menu-item-icon icon ion-ios-photos-outline tx-20"></i>
            <span class="menu-item-label">All Courses</span>
          </a><!-- br-menu-link -->
          <ul class="br-menu-sub">
        ...
        <li class="br-menu-item">
          ...
          <ul class="br-menu-sub">
            <li class="sub-item"><a href="{{ route('curriculum.manage') }}" class="sub-link">All Course Curriculum</a></li>
            <li class="sub-item"><a href="{{ route('curriculum.create') }}" class="sub-link">Create Course Curriculum</a></li>
          </ul>
        </li>
        ...
        <li class="br-menu-item">
          ...
          <ul class="br-menu-sub">
            ...
            <li class="sub-item"><a href="{{ route('coupon.create') }}" class="sub-link">Create New Coupon Codes</a></li>
          </ul>
        </li>
        ...
        <li class="br-menu-item">
          ...
          <ul class="br-menu-sub">
            ...
            <li class="sub-item"><a href="{{ route('batch.manage') }}" class="sub-link">All Batches</a></li>
